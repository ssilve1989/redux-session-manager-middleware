...
This module is deprecated in favor of [redux-session-manager](https://github.com/ssilve1989/redux-session-manager) 
which is a much better way to handle persisting state over middleware.
